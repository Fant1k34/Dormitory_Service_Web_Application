...
public class ServiceDatabase {
    ...
    public static void create(String tableName){
        try{
            ...
            Connection connection = DriverManager.getConnection(ServiceDatabase.url);
            Statement statement = connection.createStatement();

            switch (tableName){
                case "User":
                    statement.execute("CREATE TABLE IF NOT EXISTS User (user_id int GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY," +
                    ...
                    break;
                case "Permission":
                    statement.execute("CREATE TABLE IF NOT EXISTS Permission (group_id int GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY," +
                            "see_new_com int," +
                            "see_new_mar int," +
                            "add_new_com int," +
                            "add_new_mar int," +
                    ...
                    break;
                case "CommonNews":
                    statement.execute("CREATE TABLE IF NOT EXISTS CommonNews (new_com_id int GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY," +
                            "title varchar(500)," +
                            "text varchar(3000)," +
                            "author_id int," +
                            "date timestamp," +
                    ...
                    break;
                case "MarketNews":
                    statement.execute("CREATE TABLE IF NOT EXISTS MarketNews (new_mar_id int GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY," +
                            "title varchar(500)," +
                            "text varchar(3000)," +
                            "author_id int," +
                            "date timestamp," +
                    ...
                    break;
                case "PinnedMessage":
                    statement.execute("CREATE TABLE IF NOT EXISTS CommonNews (mes_id int GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY," +
                            "title varchar(500)," +
                            "text varchar(2000)," +
                            "color_id int)");
                    break;
                case "PictureCommon":
                    statement.execute("CREATE TABLE IF NOT EXISTS Tag (tag_id int GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY," +
                            "tag_text varchar(25)" +
                            ")");
                    break;
                case "Color":
                    statement.execute("CREATE TABLE IF NOT EXISTS Color (color_id int GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY," +
                            "red int," +
                            "green int," +
                            "blue int)");
                    break;
