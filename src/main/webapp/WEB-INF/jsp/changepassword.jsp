...
<div class="d-flex align-items-start">
    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <div class="alert alert-light" role="alert">
            ...
            <form:form method="post" modelAttribute="password" action="/changepassword">



                <div class="row g-3 align-items-center">
                    <div class="col-auto">
                        <label for="inputPassword" class="col-form-label">Действующий пароль</label>
                    </div>
                    <div class="col-auto">
                        <form:input path="prevPass" id="inputPassword" type="password" class="form-control"/>
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-auto">
                        <label for="inputPassword2" class="col-form-label">Введите новый пароль</label>
                    </div>
                    <div class="col-auto">
                        <form:input path="newPass1" id="inputPassword2" type="password" class="form-control"/>
    ...
    <span id="passwordHelpInline" class="form-text">
      Must be 8-20 characters long.
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-auto">
                        <form:input path="newPass2" id="inputPassword3" type="password" class="form-control"/>
                        <form:errors path="newPass2"/>
                    </div>
                    <div class="col-auto">
                    </div>
                </div>

                <input type="submit" src="/changepassword" class="btn btn-primary" value="Обновить пароль">
            </form:form>
